...
const Header: React.FC = () => {
  return (
    <header className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-[70px] py-12 sm:py-20 lg:py-[150px] flex flex-col lg:flex-row justify-between items-center lg:items-start gap-8 lg:gap-0">
